...
When a `.novc/` script becomes part of an ongoing, repeatable workflow, promote it to a permanent location immediately. Do not let useful scripts live permanently in `.novc/`.
